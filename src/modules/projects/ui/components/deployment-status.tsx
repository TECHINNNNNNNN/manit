    ...
    return (
        <div className="flex flex-wrap items-center gap-2">
            ...
            <div className={`flex items-center gap-1.5 px-2 py-1 rounded-md ${bg}`}>
                {icon}
                <span className={`text-sm font-ui font-medium ${color}`}>{text}</span>
            </div>
            ...
            {(status === 'DEPLOYED' || status === 'DEPLOYING') && shareUrl && (
                <>
                    ...
                    >
                        ...
                        <span className="font-ui">Copy Link</span>
                    </Button>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button size="sm" variant="outline" className="gap-1.5">
                                ...
                                <span className="font-ui">Share</span>
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end" className="w-56">
                            ...
                            >
                                ...
                                <span className="font-ui">Show QR Code</span>
                            </DropdownMenuItem>
                            ...
                            >
                                ...
                                <span className="font-ui">Share on X</span>
                            </DropdownMenuItem>
                            ...
                            >
                                ...
                                <span className="font-ui">Share on LinkedIn</span>
                            </DropdownMenuItem>
                    ...
                    >
                        ...
                        <span className="font-ui">View Live</span>
                    </Button>
                </>
            )}
            ...
            <Dialog open={showQR} onOpenChange={setShowQR}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="font-ui font-semibold">QR Code for {projectName}</DialogTitle>
                    </DialogHeader>
                    <div className="flex flex-col items-center gap-4 py-4">
                        ...
                        <p className="text-sm text-gray-600 text-center font-ui">
                        ...
                        >
                            {copied ? (
                                <>
                                    ...
                                    <span className="font-ui">Copied!</span>
                                </>
                            ) : (
                                <>
                                    <Link2 className="w-4 h-4 mr-2" />
                                    <span className="font-ui">Copy URL</span>
                                </>
                            )}
                        </Button>
                    </div>
